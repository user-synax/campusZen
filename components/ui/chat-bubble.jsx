...
const MessageBubbleContext = createContext({
    animateIn: true,
    variant: "soft",
});
const MessageBubbleLayoutContext = createContext(() => {});
...
function bubbleContentClass(variant, interactive) {
    return cn(
...
function bubbleSurfaceClass(variant, align) {
    return cn(
