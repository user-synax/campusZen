...
/**
 * Convert a Web API File to a Node.js Buffer for reliable server-side uploads.
 * The browser `appwrite` SDK can struggle with File objects in Vercel serverless.
 */
